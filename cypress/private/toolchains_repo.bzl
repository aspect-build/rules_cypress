...
def _resolved_toolchain_impl(ctx):
    toolchain_info = ctx.toolchains["@aspect_rules_cypress//cypress:toolchain_type"]
    return [
        toolchain_info,
        toolchain_info.default,
        toolchain_info.cypressinfo,
...
#
# Register these from MODULE.bazel with `register_toolchains("@cypress_toolchains//:all")`,
# or pass them to the --extra_toolchains flag.
